...
const PERGUNTAS = [
  { title: "Vocês trabalham com qualquer empresa?", body: "Não necessariamente. Depende do contexto e da nossa capacidade real de gerar valor — avaliamos isso juntos na primeira conversa." },
  { title: "Vocês garantem a entrada em determinado cliente?", body: "Não prometemos o que não podemos garantir. Entregamos estratégia, aproximação e condução; as decisões finais pertencem às partes." },
